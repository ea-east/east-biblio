<mods xmlns="http://www.loc.gov/mods/v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ID="uuid-9e285531-c1d0-414b-affb-b0c9e4dd553a" version="3.4" xsi:schemaLocation="http://www.loc.gov/mods/v3 http://cluster-schemas.uni-hd.de/modsCluster.xsd">
    <titleInfo>
        <title>Seshin yuishiki no genten kaimei</title>
    </titleInfo>
    <titleInfo lang="eng" type="translated">
        <title>Philological explanations of Vasubandhu's Viñaptimātratā</title>
    </titleInfo>
    <name type="personal">
        <namePart type="given">J.</namePart>
        <namePart type="family">Nozawa</namePart>
        <role>
    ...
    <originInfo>
        ...
        <dateIssued encoding="w3cdtf">1953</dateIssued>
    ...
    <recordInfo lang="eng" script="Latn">
        ...
        <recordCreationDate encoding="w3cdtf">2011-03-06+01:00</recordCreationDate>
